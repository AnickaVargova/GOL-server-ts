...
app.get("/:setting", function (req, res) {
    ...
    //   path.join(__dirname, `./settings/${patternName}`)
    // );
    //@ts-expect-error
...
fs_1.default.readFile("./responseUpdate.ts", "utf8", function (err, data) {
    if (err) {
...
app.post("/:setting", function (req, res) {
    ...
    // );
    fs_1.default.appendFile("responseUpdate.ts", "export const " + patternName + " =", function () {
        console.log(newPattern, patternName);
        fs_1.default.appendFile("responseUpdate.ts", JSON.stringify(newPattern), function () {
            fs_1.default.appendFile("responseUpdate.ts", ";", function () {
                console.log("success!");
            });
        });
    });
