...
app.post("/:setting", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var newPattern;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                fs_1.default.appendFile("responseUpdate.ts", "export const " + newPattern[0] + " =", function () {
                    fs_1.default.appendFile("responseUpdate.ts", JSON.stringify(newPattern[1]), function () {
